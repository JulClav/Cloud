...
# Create config.js inside the './dist' directory.
# The WORKDIR in the Dockerfile is /app, so this resolves to /app/dist/config.js
# index.html will load this file (e.g., <script src="/config.js"></script>)
echo "window.API_URL = '${EFFECTIVE_API_URL}';" > ./dist/config.js
